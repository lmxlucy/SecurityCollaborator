...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference('Device.count') do
      post devices_url, params: { device: { q1: @device.q1, q2: @device.q2, q3: @device.q3, q4: @device.q4 } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { q1: @device.q1, q2: @device.q2, q3: @device.q3, q4: @device.q4 } }
